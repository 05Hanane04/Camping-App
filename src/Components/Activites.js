...
export default function Activites() {
  ...
  return (
    <div className="activites-div">
      ...
      <h2 data-aos="fade-up" data-aos-delay="100">Terre d'Océan - Activités</h2>

<div className="activite1" data-aos="fade-up" data-aos-delay="200">
  <img src={piscine} alt="photo" data-aos="fade-up" data-aos-delay="300" />
  <h3 data-aos="fade-up" data-aos-delay="400">PISCINE</h3>
  <h4 data-aos="fade-up" data-aos-delay="500">
    Venez passer une agréable journée au bord de notre piscine à Taghazout
    (entrée à 90 Dhs pour les adultes et 50 Dhs pour les enfants (-de 1.20 m) - GRATUIT pour les résidents du camping).
  </h4>
</div>
...
<div className="activite2" data-aos="fade-up" data-aos-delay="600">
  <img src={surf} alt="photo" data-aos="fade-up" data-aos-delay="700" />
  <h3 data-aos="fade-up" data-aos-delay="800">SURF</h3>
  <h4 data-aos="fade-up" data-aos-delay="900">
